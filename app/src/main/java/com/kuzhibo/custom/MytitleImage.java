...
public class MytitleImage extends ImageView {
    //中间值用来设置用户头像的颜色
    ...
    public MytitleImage(Context context) {
        super(context);
    }

    public MytitleImage(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public MytitleImage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
