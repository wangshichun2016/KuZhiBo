...
public class VideoViewPlayingActivity extends Activity implements OnPreparedListener, OnCompletionListener,
     ...
     */
    private String AK = "ef234d3bce3e4551a35667d0f4b4177c";   //请录入您的AK !!!

    //    private String mVideoSource = null;
    private String mVideoSource = "http://ksdownhdl.jufan.tv/live/500240920.flv";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case EVENT_PLAY:
                     ...
                     * 设置播放url
                     */
                    mVV.setVideoPath("http://ksdownhdl.jufan.tv/live/500240920.flv");
